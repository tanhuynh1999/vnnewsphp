        ...
        <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <form class="ui form" role="form" method="post" action="{{URL::to('/loginpost')}}">
                        ...
                        <div class="row mb-3 px-3"> <button type="submit" class="ui primary submit button">Đăng nhập</button> </div>
                        
                        <div class="row mb-4 px-3"> <small class="font-weight-bold">Nếu chưa có tài khoản? <a class="text-danger " href="/vnnews/reg">Đăng ký ngay</a></small> </div>
